...
<#macro sessionBeanItem sessionBeans type title>
	...
	<div class="item-body indented" id="${type}Body">
		...
		<#list sessionBeanNames as sessionBeanName>
			...
			<div class="item-body content" id="${type}${sessionBeanName_index}Body">
				<table>
...
<div>
	...
	<div class="item-body indented" id="sessionBeansBody">
