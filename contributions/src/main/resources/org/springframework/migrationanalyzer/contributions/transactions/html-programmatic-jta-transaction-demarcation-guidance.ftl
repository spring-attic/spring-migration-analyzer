...
<a href="http://static.springsource.org/spring/docs/3.1.x/spring-framework-reference/html/transaction.html#transaction-programmatic">programmatic transactions</a>.
During the migration is may also be worth considering replacing the programmatic transactions with
<a href="http://static.springsource.org/spring/docs/3.1.x/spring-framework-reference/html/transaction.html#transaction-declarative">declarative transactions</a>
...
<a href="http://static.springsource.org/spring/docs/3.1.x/spring-framework-reference/html/transaction.html#transaction-programmatic">programmatic transaction</a> support.